...
export async function notifyUser(userId, payload) {
  const { title, body, url = null, tag = null, icon = '/velte_logo_esn5dj.png', type = 'system', requireInteraction = false, metadata = null } = payload;
  ...
  const pushPayload = JSON.stringify({ title, body, url, tag, icon, requireInteraction });
